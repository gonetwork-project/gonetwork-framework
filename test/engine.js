...
engineLib = require('../src/state-channel/engine');
channel = require('../src/state-channel/channel');
message = require('../src/state-channel/message');
merkletree = require('../src/state-channel/merkletree');
