...
const infuraAccounts = [
  ...
  tests.account('b507928218b7b1e48f82270011149c56b6191cd1f2846e01c419f0a1a57acc42', 'f0c3043550e5259dc1c838d0ea600364d999ea15'),
  tests.account('4c65754b227fb8467715d2949555abf6fe8bcba11c6773433c8a7a05a2a1fc78', 'b0ae572146ab8b5990e069bff487ac25635dabe8'),
  tests.account('a8344e81509696058a3c14e520693f94ce9c99c26f03310b2308a4c59b35bb3d', 'ff8a018d100ace078d214f02be8df9c6944e7a2b'),
  tests.account('157258c195ede5fad2f054b45936dae4f3e1b1f0a18e0edc17786d441a207224', 'f77e9ef93380c70c938ca2e859baa88be650d87d'),
  // fresh accounts with some eth
  tests.account('b2267a87f32cb5375341fddad567921db4fd3b8d6e6b752605e6fbd6b6afc0ca', 'ca4e935c9e4d942afd42f2c932a4ab9320eda68c'),
  tests.account('c712c08b0c42c073f8c67cf5c0fa8c4cf5ffa89c0b33c2d4e53aa4fe969da887', 'f8e9b7b0f5936c0221b56f15ea2182d796d09e63')
]
...
export const infura: () => InfuraConfig = () => ({
  ...
  // get mqttUrl () { throw new Error('NOT USED IN UNIT TESTS') },
  mqttUrl: 'NOT_USED', // fixme
...
export const local = () => {
  ...
  return {
    ...
    signatureCb: ((cb) => cb(tests.accounts[0].privateKey)) as E.SignatureCb,
    owner: tests.accounts[0].address,
