...
/** @memberof channel */
exports.CHANNEL_STATE_IS_OPENING = 'opening';
/** @memberof channel */
exports.CHANNEL_STATE_IS_CLOSING = 'closing';
/** @memberof channel */
exports.CHANNEL_STATE_IS_SETTLING = 'settling';
/** @memberof channel */
exports.CHANNEL_STATE_CLOSED = 'closed';
/** @memberof channel */
exports.CHANNEL_STATE_OPEN = 'opened';
/** @memberof channel */
exports.CHANNEL_STATE_SETTLED = 'settled';
/** @memberof channel */
exports.SETTLE_TIMEOUT = new util.BN(100);
...
/** @memberof channel */
exports.REVEAL_TIMEOUT = new util.BN(15);
...
class Channel {
    ...
    transferrableFromTo(from, to, currentBlock) {
        let safeBlock = null;
        if (currentBlock) {
            safeBlock = currentBlock.add(exports.REVEAL_TIMEOUT);
        }
    ...
    getChannelExpirationBlock(currentBlock) {
        if (this.closedBlock) {
            return this.closedBlock.add(exports.SETTLE_TIMEOUT);
        }
        else {
            return currentBlock.add(exports.SETTLE_TIMEOUT);
        }
    }
    /** @property {string} - return the current channel state */
    get state() {
        if (this.settledBlock) {
            return exports.CHANNEL_STATE_SETTLED;
        }
        else if (this.issuedSettleBlock) {
            return exports.CHANNEL_STATE_IS_SETTLING;
        }
        else if (this.closedBlock) {
            return exports.CHANNEL_STATE_CLOSED;
        }
        else if (this.issuedCloseBlock) {
            return exports.CHANNEL_STATE_IS_CLOSING;
        }
        else {
            return exports.CHANNEL_STATE_OPEN;
        }
    }
    /** @returns {bool} returns true iff the channel is open */
    isOpen() {
        return this.state === exports.CHANNEL_STATE_OPEN;
    }
    ...
    createMediatedTransfer(msgID, hashLock, amount, expiration, target, initiator, currentBlock) {
        ...
        let mediatedTransfer = new message.MediatedTransfer(Object.assign({
            target: target,
            initiator: initiator
        }, lockedTransfer));
    ...
    canIssueSettle(currentBlock) {
        return (this.closedBlock &&
            currentBlock.gt(this.closedBlock.add(exports.SETTLE_TIMEOUT)));
    }
...
exports.OpenLockProof = OpenLockProof;
