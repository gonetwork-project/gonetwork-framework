...
class ChannelState {
    ...
    _computeMerkleTreeWithHashlock(lock) {
        let mt = new merkletree.MerkleTree(Object.values(Object.assign({}, this.pendingLocks, this.openLocks))
            .concat(lock)
            .map(function (l) {
    ...
    _computeMerkleTreeWithoutHashlock(lock) {
        ...
        let mt = new merkletree.MerkleTree(Object.values(locks).map(function (l) {
            return l.getMessageHash();
        }));
        mt.generateHashTree();
        return mt;
